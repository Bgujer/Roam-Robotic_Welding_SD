...
3. Plug values into calibration script
4. Use angles to offset plane within UFactory Studio
5. Re-run program and re-record values
6. Repeat steps 3-5 until within acceptable tolerance
